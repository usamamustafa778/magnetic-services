...
export default function Trust() {
  return (
    <FullContainer>
      <div className="bg-gray-900 w-full h-full flex items-center justify-center py-32">
        <div className="lg:text-center">
          {/* Main Heading */}
          <h2 className="text-3xl lg:text-5xl text-white font-bold mb-5">
            {trustData.heading}
          </h2>
          <div className="h-1 w-32 bg-nav"></div>

          {/* List Items */}
          <ul className="space-y-4 text-white lg:text-lg mt-10">
